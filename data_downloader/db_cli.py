...
@click.command(help=f'Create and index {STOCK_PRICE_TABLE_NAME} and {STOCK_LIST_TABLE_NAME} tables')
def init():
...
@click.command(help='Populate stocks_list table from a local csv file')
